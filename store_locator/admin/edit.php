...
$criteria['fields'][] = array('name'=>'lat', 'type'=>'hidden', 'value'=>$store[0]['lat']);
$criteria['fields'][] = array('name'=>'lng', 'type'=>'hidden', 'value'=>$store[0]['lng']);
...
if($_POST[$criteria['submit']['name']]) {
	...
	'description'=>$values['description'],'tel'=>$values['tel'],'email'=>$values['email'],'city'=>$values['city'],'country'=>$values['country'],
